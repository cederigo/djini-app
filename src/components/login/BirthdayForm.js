...
export default class BirthdayForm extends Component {
  ...
  componentDidMount() {
    trackScreenView('login: birthday')
  }
    ...
    return (
      <View style={styles.container}>
        <DjiniText style={styles.text}>
          Djini hilft dir an Geburtstage von Freunden zu denken – und deinen Freunden an deinen. So
          kannst du Geschenke rechtzeitig organisieren.
        </DjiniText>
